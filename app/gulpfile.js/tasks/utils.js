...
function utilsClean(done) {
  return gulp.series(gulp.parallel('build', utilsWipe), delClean)(done);
}
...
function utilsDist(done) {
  return gulp.series(utilsClean, pipeSrcDest)(done);
}

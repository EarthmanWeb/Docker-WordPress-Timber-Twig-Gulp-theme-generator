...
add_action('wp_enqueue_scripts', 'mytimbertheme_styles_hook');

/**
 * Enqueue Bootstrap4 scripts
 */
function mytimbertheme_enqueue_scripts()
{
	$get_bootstrap_js_dir = get_template_directory_uri() . '/vendor/twbs/bootstrap/dist/js/';
	wp_enqueue_script('bootstrap', $get_bootstrap_js_dir . '/bootstrap.bundle.min.js', array('jquery'));
}
add_action('wp_enqueue_scripts', 'mytimbertheme_enqueue_scripts');
